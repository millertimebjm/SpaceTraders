...
public class PathsServicesTests
{
    ...
    //     {
    //         new("origin", "", "", 0, 0, null, "", null, null, null),
    //         new("destination", "", "", 400, 400, null, "", null, null, null),
    //     };
    //     var path = PathsService.GetPath(
    //         waypoints,
    //         waypoints.First(),
    //         waypoints.Last(),
    //         1);
    ...
    //     {
    //         new("origin", "", "", 0, 0, null, "", null, null, null),
    //         new("destination", "", "", 1, 1, null, "", null, null, null),
    //     };
    //     var path = PathsService.GetPath(
    //         waypoints,
    //         waypoints.First(),
    ...
    //     {
    //         new("origin", "", "", 0, 0, null, "", null, null, null),
    //         new("refuel", "", WaypointTypesEnum.FUEL_STATION.ToString(), 0, 100, null, "", null, null, null),
    //         new("destination", "", "", 0, 200, null, "", null, null, null),
    //     };
    //     var path = PathsService.GetPath(
    //         waypoints,
    //         waypoints.First(),
